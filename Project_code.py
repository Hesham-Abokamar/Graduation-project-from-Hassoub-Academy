    ...
    try:
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS lessons (
                id INTEGER PRIMARY KEY,
                lesson_name TEXT,
                FOREIGN KEY (lesson_name) REFERENCES students (id)
            )
        ''')
    ...
    while try_again_main:
        ...
        try:
            ...
            if student_exists(cursor, student_id):
                ...
                cursor.execute('DELETE FROM lessons WHERE id = ?', (student_id,))
...
def show_student(cursor):
    ...
    '''.format(student_data[0], student_data[1], student_data[2], student_data[3], student_data[4], student_data[5]))
                ...
                cursor.execute('SELECT lesson_name FROM lessons WHERE id = ?', (student_id,))
